...
The codebase includes more advanced preprocessing options (TV denoising, bilateral filtering, spatial feature extraction) and alternative segmentation approaches (including kernel K-means), but the main workflow sticks to a simple preprocessing pipeline and compares three classical clustering methods learned in class.
